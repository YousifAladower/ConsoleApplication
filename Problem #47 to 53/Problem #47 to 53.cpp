...
int GetDifferenceInDaysV(stDate Date1, stDate Date2, bool IncludeEndDay = false)
{
	int Days = 0;
	while (IsDate1BeforeDate2(Date1, Date2))
	{
...
short GetVacationDays(stDate Date1, stDate Date2)
{
	stDate EndOfYearDate;
	EndOfYearDate.Day = 31;
	EndOfYearDate.Month = 12;
	EndOfYearDate.Year = Date1.Year;
	return GetDifferenceInDaysV(Date1, Date2, true);
}
...
int main()
{
	...
	//cout << "\n Day of Vacation: " << GetVacationDays(Date1, Date2) << " Days.";
